...
export const Settings: React.FC<SettingsProps> = ({ user, onBack, onSettingsUpdate, onShowUpgradeModal, initialActiveSection, onSectionChange, featureAccess }) => {
  ...
  // Handle applying affiliate code
  const handleApplyAffiliateCode = async () => {
    ...
    try {
      ...
      logger.error('Failed to apply affiliate code:', { error });
      showError('Error', 'Failed to apply affiliate code. Please try again.');
    } finally {
      setApplyingAffiliateCode(false);
    }
  };
  ...
  const copyAffiliateLink = () => {
    ...
    const link = generateAffiliateLink(affiliateData.affiliateCode);
    navigator.clipboard.writeText(link);
    showSuccess('Copied!', 'Affiliate link copied to clipboard');
  };
  ...
  const copyAffiliateCode = () => {
    ...
    showSuccess('Copied!', 'Affiliate code copied to clipboard');
  };
