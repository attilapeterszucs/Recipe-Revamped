  ...
  try {
    ...
    const backupData = {
      ...
      settings: {
        ...
        ...((settings as any).recipeReminders !== undefined && { recipeReminders: (settings as any).recipeReminders }),
        ...
        ...((settings as any).aiModelPreference !== undefined && { aiModelPreference: (settings as any).aiModelPreference }),
        ...((settings as any).saveGeneratedRecipes !== undefined && { saveGeneratedRecipes: (settings as any).saveGeneratedRecipes }),
