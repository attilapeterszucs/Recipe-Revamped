                          ...
                          <div className="space-y-2">
                            {recipes.map((recipe, index) => (
                              <div 
                                ...
                                onDragEnd={handleDragEnd}
                              >
                                <div className="bg-white rounded-xl border-2 border-gray-200 hover:border-green-400 hover:shadow-xl transition-all duration-300 shadow-md overflow-hidden cursor-move">
                                  {/* Recipe Image */}
                                  ...
                                  {/* Drag Handle */}
                                  <div className="absolute top-2 left-2 bg-black/50 backdrop-blur-sm text-white opacity-0 group-hover:opacity-100 transition-all duration-200 p-1.5 rounded-full cursor-move">
                      ...
                      {dayMeals.snacks && dayMeals.snacks.length > 0 && (
                        dayMeals.snacks.map((snack, snackIndex) => (
                          <div 
                            ...
                            onDragEnd={handleDragEnd}
                          >
                            <div className="bg-white rounded-xl border-2 border-gray-200 hover:border-orange-400 hover:shadow-xl transition-all duration-300 shadow-md overflow-hidden transform hover:scale-105 cursor-move">
                              {/* Snack Image */}
