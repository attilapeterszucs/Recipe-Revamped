      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20 gap-2">
          <Link to={backLink} className="flex items-center gap-2 sm:gap-3 group flex-shrink min-w-0">
            ...
            <span className="text-lg sm:text-xl md:text-2xl font-black bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent truncate">{title}</span>
          </Link>
